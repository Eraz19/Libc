...
static void	init(void)
{
	...
	g_test.suites[0x3] = (s_test_suite){ FALSE, "stringarray",	NULL/*testsuite_stringarray*/ };
	g_test.suites[0x4] = (s_test_suite){ FALSE, "convert",		testsuite_convert };
	g_test.suites[0x5] = (s_test_suite){ FALSE, "color",		NULL/*testsuite_color*/ };
	g_test.suites[0x6] = (s_test_suite){ FALSE, "list",			testsuite_list };
	g_test.suites[0x7] = (s_test_suite){ FALSE, "math",			NULL/*testsuite_math*/ };
	g_test.suites[0x8] = (s_test_suite){ FALSE, "stat",			NULL/*testsuite_stat*/ };
	g_test.suites[0x9] = (s_test_suite){ FALSE, "random",		NULL/*testsuite_random*/ };
	g_test.suites[0xA] = (s_test_suite){ FALSE, "vlq",			NULL/*testsuite_vlq*/ };
